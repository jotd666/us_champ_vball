...
player_direction_copy_0254 = $254
...
61F5: 85 1B    sta $1b
61F7: 38       sec
61F8: B5 57    lda score_array_57, x
...
6234: 85 1B    sta $1b
6236: 38       sec
6237: B5 57    lda score_array_57, x
...
660A: 48       pha
660B: A0 00    ldy #$00
660D: 20 0A D0 jsr pseudo_random_d00a
6610: 18       clc
6611: 4A       lsr a
6612: C9 64    cmp #$64
6614: 90 07    bcc $661d
...
6A46: A8       tay
6A47: 38       sec
6A48: B5 57    lda score_array_57, x
...
6B48: 09 20    ora #$20
6B4A: 85 56    sta $56
6B4C: 20 0A D0 jsr pseudo_random_d00a
6B4F: 29 07    and #$07
6B51: C9 07    cmp #$07
6B53: D0 02    bne $6b57
6B55: A9 06    lda #$06
...
6B63: 29 DF    and #$df
6B65: 85 56    sta $56
6B67: 20 0A D0 jsr pseudo_random_d00a
6B6A: 29 07    and #$07
6B6C: C9 06    cmp #$06
6B6E: 90 02    bcc $6b72
6B70: A9 05    lda #$05
...
6CF1: C9 0D    cmp #$0d
6CF3: F0 27    beq $6d1c
6CF5: 20 0A D0 jsr pseudo_random_d00a
6CF8: 29 3F    and #$3f
6CFA: 18       clc
6CFB: 69 10    adc #$10
6CFD: 4A       lsr a
...
6D7D: 20 0A D0 jsr pseudo_random_d00a
6D80: 29 03    and #$03
6D82: C9 02    cmp #$02
6D84: 90 02    bcc $6d88
6D86: A9 02    lda #$02
...
6EBA: E9 0A    sbc #$0a
6EBC: 85 1B    sta $1b
6EBE: 20 0A D0 jsr pseudo_random_d00a
6EC1: 29 03    and #$03
6EC3: C9 03    cmp #$03
6EC5: D0 02    bne $6ec9
6EC7: A9 01    lda #$01
...
7109: 20 26 90 jsr compute_player_direction_9026
...
71B6: 20 26 90 jsr compute_player_direction_9026
...
7247: 20 26 90 jsr compute_player_direction_9026
...
72C0: 20 26 90 jsr compute_player_direction_9026
...
7377: 20 26 90 jsr compute_player_direction_9026
...
748A: 20 26 90 jsr compute_player_direction_9026
...
7532: 20 26 90 jsr compute_player_direction_9026
...
75A0: 20 26 90 jsr compute_player_direction_9026
...
75D5: 20 26 90 jsr compute_player_direction_9026
...
7721: 20 26 90 jsr compute_player_direction_9026
...
775E: 20 26 90 jsr compute_player_direction_9026
...
783A: 20 26 90 jsr compute_player_direction_9026
...
78CC: 20 26 90 jsr compute_player_direction_9026
...
7A41: 20 26 90 jsr compute_player_direction_9026
...
7A89: 20 26 90 jsr compute_player_direction_9026
...
7D3F: 20 26 90 jsr compute_player_direction_9026
...
7DA3: 20 26 90 jsr compute_player_direction_9026
...
7E33: 20 26 90 jsr compute_player_direction_9026
...
7E84: 20 26 90 jsr compute_player_direction_9026
...
809E: 20 26 90 jsr compute_player_direction_9026
...
80DA: 20 26 90 jsr compute_player_direction_9026
...
81DB: 20 26 90 jsr compute_player_direction_9026
...
823A: 20 26 90 jsr compute_player_direction_9026
...
8267: 20 23 69 jsr compare_player_positions_6923
826A: A5 1B    lda $1b
826C: C9 04    cmp #$04
826E: B0 09    bcs $8279
8270: A5 1C    lda $1c
...
82BE: 20 23 69 jsr compare_player_positions_6923
82C1: 68       pla
82C2: A8       tay
...
84EE: 20 23 69 jsr compare_player_positions_6923
...
8572: 20 23 69 jsr compare_player_positions_6923
8575: A5 23    lda $23
8577: D0 14    bne $858d
...
8CCA: 29 02    and #$02
8CCC: 45 1B    eor $1b
8CCE: F0 2F    beq initialize_logical_xy_players_8cff
8CD0: 18       clc
...
8CFF: 8A       txa
8D00: C5 4F    cmp $4f
8D02: D0 22    bne initialize_logical_xy_players_8d26
8D04: 20 0A D0 jsr pseudo_random_d00a
8D07: 29 03    and #$03
8D09: 06 1B    asl $1b
8D0B: 65 1B    adc $1b
8D0D: 0A       asl a
...
9201: 9D 54 02 sta player_direction_copy_0254, x
...
92A0: 9D 54 02 sta player_direction_copy_0254, x
92A3: 18       clc
92A4: 69 10    adc #$10
92A6: 4A       lsr a
92A7: 4A       lsr a
...
932E: BD 54 02 lda player_direction_copy_0254, x
...
934D: 9D 54 02 sta player_direction_copy_0254, x
9350: 18       clc
9351: 69 10    adc #$10
9353: 29 E0    and #$e0
9355: 4A       lsr a
...
9366: 20 15 A2 jsr player_walks_a215
9369: B0 0D    bcs $9378
...
93AD: 9D 54 02 sta player_direction_copy_0254, x
93B0: A9 40    lda #$40
...
callback_93e7:
93E7: BD 54 02 lda player_direction_copy_0254, x
93EA: 10 03    bpl $93ef
...
941E: 29 40    and #$40
9420: D0 09    bne $942b
9422: 20 15 A2 jsr player_walks_a215
...
callback_9515:
9515: 20 15 A2 jsr player_walks_a215
...
9655: 9D 54 02 sta player_direction_copy_0254, x
9658: BD F0 02 lda $02f0, x
965B: C9 03    cmp #$03
965D: D0 58    bne $96b7
965F: 20 15 A2 jsr player_walks_a215
9662: B0 03    bcs $9667
...
96F7: 9D 54 02 sta player_direction_copy_0254, x
96FA: 18       clc
96FB: 69 10    adc #$10
96FD: 29 E0    and #$e0
96FF: 4A       lsr a
...
9756: 20 15 A2 jsr player_walks_a215
9759: B0 03    bcs $975e
...
9786: 20 15 A2 jsr player_walks_a215
9789: B0 03    bcs $978e
...
9888: 9D 54 02 sta player_direction_copy_0254, x
988B: 18       clc
988C: 69 10    adc #$10
988E: 29 E0    and #$e0
9890: 4A       lsr a
...
98F2: 20 15 A2 jsr player_walks_a215
98F5: B0 03    bcs $98fa
...
9922: 20 15 A2 jsr player_walks_a215
9925: B0 03    bcs $992a
...
99C1: 9D 54 02 sta player_direction_copy_0254, x
99C4: A9 10    lda #$10
99C6: 9D 61 02 sta $0261, x
99C9: 20 15 A2 jsr player_walks_a215
99CC: B0 03    bcs $99d1
...
9B1F: BD 54 02 lda player_direction_copy_0254, x
9B22: 18       clc
9B23: 69 10    adc #$10
9B25: 29 E0    and #$e0
9B27: 4A       lsr a
...
9B52: BD 54 02 lda player_direction_copy_0254, x
9B55: 10 03    bpl $9b5a
...
9B66: BD 54 02 lda player_direction_copy_0254, x
9B69: 18       clc
9B6A: 69 80    adc #$80
9B6C: 9D C4 03 sta $03c4, x
9B6F: BD F0 02 lda $02f0, x
9B72: F0 20    beq $9b94
9B74: 20 15 A2 jsr player_walks_a215
9B77: B0 03    bcs $9b7c
...
A118: 20 15 A2 jsr player_walks_a215
A11B: B0 03    bcs $a120
...
A21E: B5 C7    lda $c7, x
A220: 48       pha
A221: BD 54 02 lda player_direction_copy_0254, x
A224: 18       clc
A225: 69 10    adc #$10
A227: 29 E0    and #$e0
A229: 4A       lsr a
...
A759: A9 00    lda #$00
A75B: 9D 54 02 sta player_direction_copy_0254, x
A75E: A0 84    ldy #$84
...
A799: A9 01    lda #$01
A79B: 9D 54 02 sta player_direction_copy_0254, x
A79E: B5 73    lda $73, x
A7A0: 85 1B    sta $1b
A7A2: A9 81    lda #$81
A7A4: 95 73    sta $73, x
...
A7D5: D0 0B    bne $a7e2
A7D7: BD 54 02 lda player_direction_copy_0254, x
A7DA: C9 01    cmp #$01
A7DC: D0 04    bne $a7e2
A7DE: A9 81    lda #$81
A7E0: 95 73    sta $73, x
...
A833: D0 0B    bne $a840
A835: BD 54 02 lda player_direction_copy_0254, x
A838: C9 01    cmp #$01
A83A: D0 04    bne $a840
A83C: A9 81    lda #$81
A83E: 95 73    sta $73, x
...
ACF2: A5 01    lda $01
ACF4: 48       pha
ACF5: 20 F3 DF jsr convert_logical_to_screen_coords_dff3
ACF8: 68       pla
ACF9: 85 01    sta $01
ACFB: 68       pla
ACFC: 85 00    sta $00
...
B563: A9 04    lda #$04
B565: 05 07    ora unknown_07
B567: 85 07    sta unknown_07
B569: A5 04    lda $04
...
B5C4: BD 54 02 lda player_direction_copy_0254, x
B5C7: 85 00    sta $00
...
BC46: 18       clc
BC47: 69 01    adc #$01
BC49: 95 57    sta score_array_57, x
BC4B: D8       cld
BC4C: A0 38    ldy #$38
BC4E: B5 47    lda $47, x
BC50: 10 02    bpl $bc54
...
BEEF: 9D 54 02 sta player_direction_copy_0254, x
...
CD9B: 9D 54 02 sta player_direction_copy_0254, x
CD9E: 60       rts
CD9F: 18       clc
...
; < A: pseudo-random
pseudo_random_d00a:
D00A: 84 1A    sty $1a		; save Y
D00C: A0 04    ldy #$04
D00E: E6 2B    inc random_index_2b
D010: E6 2D    inc random_index_2d
; do the following 4 times
D012: 66 2C    ror random_gen_2c
D014: 66 2D    ror random_index_2d
D016: 66 2E    ror random_gen_2e
D018: B0 06    bcs $d020
D01A: A5 2D    lda random_index_2d
D01C: 65 2B    adc random_index_2b
D01E: 85 2D    sta random_index_2d
D020: 88       dey
D021: D0 EF    bne $d012
D023: A5 2C    lda random_gen_2c
D025: 65 2E    adc random_gen_2e
D027: 85 2E    sta random_gen_2e
D029: 65 2D    adc random_index_2d
D02B: A4 1A    ldy $1a		; restore Y
D02D: 60       rts
...
D8F4: 8D 36 02 sta previous_player_1_controls_0236
...
D917: 8D 37 02 sta previous_player_2_controls_0237
...
F3DD: AA       tax
; check for score > 8
F3DE: B5 57    lda score_array_57, x
F3E0: C9 08    cmp #APPROACHING_MAX_SCORE
F3E2: B0 05    bcs $f3e9
