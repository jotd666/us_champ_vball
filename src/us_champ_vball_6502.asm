...
870E: 0A       asl a
870F: A8       tay
8710: B9 1D 87 lda $871d, y
8713: 85 1B    sta $1b
8715: B9 1E 87 lda $871e, y
8718: 85 1C    sta $1c
871A: 6C 1B 00 jmp ($001b)
871D: 3D 87 6C and $6c87, x
8720: 87 A6    sax $a6
8722: 87 3D    sax $3d
8724: 87 6C    sax $6c
8726: 87 A6    sax $a6
...
873A: 87 D5    sax $d5
873C: 87 A5    sax $a5
873E: 1E 0A 65 asl $650a, x
8741: 1E A8 8A asl $8aa8, x
8744: 29 02    and #$02
8746: F0 12    beq $875a
...
87FF: 85 1D    sta $1d
8801: 60       rts
8802: FF FF FF isb $ffff, x
8805: FF FF FF isb $ffff, x
8808: FF FF 02 isb $02ff, x
880B: 02       kil
880C: FF 01 02 isb $0201, x
880F: 02       kil
8810: 00       brk
8811: 00       brk
8812: FF FF FF isb $ffff, x
8815: FF FF FF isb $ffff, x
8818: FF FF FF isb $ffff, x
881B: 01 50    ora ($50, x)
881D: 20 01 18 jsr $1801
8820: 48       pha
8821: 01 20    ora ($20, x)
8823: 20 00 B8 jsr $b800
8826: 20 00 E8 jsr $e800
8829: 48       pha
882A: 00       brk
882B: EC 20 01 cpx $0120
882E: 50 20    bvc $8850
8830: 01 20    ora ($20, x)
8832: 20 01 20 jsr $2001
8835: 20 01 48 jsr $4801
8838: 70 01    bvs $883b
883A: 14 70    nop $70, x
883C: 01 14    ora ($14, x)
883E: 70 00    bvs $8840
8840: B8       clv
8841: 20 00 EC jsr $ec00
8844: 20 00 EC jsr $ec00
8847: 20 00 B8 jsr $b800
884A: 70 00    bvs $884c
884C: E0 70    cpx #$70
884E: 00       brk
884F: E0 70    cpx #$70
...
8B8C: 68       pla
8B8D: 00       brk
8B8E: EC 28 00 cpx $0028
8B91: EC 28 00 cpx $0028
8B94: E0 68    cpx #$68
8B96: 00       brk
8B97: E0 68    cpx #$68
8B99: 00       brk
...
8C3F: 00       brk
8C40: C8       iny
8C41: 3C 01 38 nop $3801, x
8C44: 54 01    nop $01, x
8C46: 40       rti
8C47: 3C 00 C0 nop $c000, x
8C4A: 48       pha
8C4B: 01 40    ora ($40, x)
8C4D: 48       pha
8C4E: 8A       txa
...
8DFF: 94 48    sty $48, x
8E01: 07 01    slo $01
8E03: 2C 48 11 bit $1148
8E06: 01 2C    ora ($2c, x)
8E08: 48       pha
8E09: 11 01    ora ($01), y
8E0B: 2C 48 11 bit $1148
8E0E: 01 68    ora ($68, x)
8E10: 68       pla
8E11: 16 01    asl $01, x
8E13: 2C 48 11 bit $1148
8E16: 01 6C    ora ($6c, x)
8E18: 48       pha
8E19: 17 01    slo $01, x
8E1B: 70 28    bvs $8e45
...
8E29: 17 00    slo $00, x
8E2B: 42       kil
8E2C: 20 0D 00 jsr $000d
8E2F: 46 38    lsr $38
8E31: 0D 00 4A ora $4a00
8E34: 58       cli
8E35: 0D 00 4E ora $4e00
8E38: 70 0D    bvs $8e47
8E3A: 01 BE    ora ($be, x)
8E3C: 20 1D 01 jsr $011d
8E3F: BA       tsx
8E40: 38       sec
8E41: 1D 01 B6 ora $b601, x
8E44: 58       cli
8E45: 1D 01 B2 ora $b201, x
8E48: 70 1D    bvs $8e67
8E4A: 00       brk
8E4B: D4 48    nop $48, x
8E4D: 01 01    ora ($01, x)
8E4F: 2C 48 11 bit $1148
8E52: 00       brk
8E53: D4 48    nop $48, x
8E55: 01 00    ora ($00, x)
8E57: 94 48    sty $48, x
8E59: 07 01    slo $01
8E5B: 2C 48 11 bit $1148
8E5E: 01 6C    ora ($6c, x)
8E60: 48       pha
8E61: 17 00    slo $00, x
8E63: 46 38    lsr $38
8E65: 0D 01 BA ora $ba01
8E68: 38       sec
8E69: 1D 00 D4 ora $d400, x
8E6C: 48       pha
8E6D: 01 01    ora ($01, x)
8E6F: 2C 48 11 bit $1148
8E72: 00       brk
8E73: D0 68    bne $8edd
8E75: 00       brk
8E76: 00       brk
...
8E86: 00       brk
8E87: E8       inx
8E88: 20 00 01 jsr $0100
8E8B: 28       plp
8E8C: 20 10 01 jsr $0110
8E8F: 58       cli
8E90: 40       rti
8E91: 10 8A    bpl $8e1d
8E93: 49 01    eor #$01
...
917A: 0A       asl a
917B: A8       tay
917C: B9 8A 91 lda $918a, y
917F: 85 10    sta $10
9181: B9 8B 91 lda $918b, y
9184: 85 11    sta $11
9186: 6C 10 00 jmp ($0010)
9189: 60       rts
918A: 10 92    bpl $911e
918C: 10 92    bpl $9120
918E: 10 92    bpl $9122
...
91B6: 70 99    bvs $9151
91B8: 8A       txa
91B9: 99 AB 99 sta $99ab, y
91BC: DF 99 22 dcp $2299, x
91BF: 9A       txs
91C0: 22       kil
91C1: 9A       txs
91C2: 22       kil
...
91C8: D4 9A    nop $9a, x
91CA: E5 9A    sbc $9a
91CC: FE 9A 0F inc $0f9a, x
91CF: 9B B2 9B shs $9bb2, y
91D2: DA       nop
91D3: 9B 00 00 shs $0000, y
91D6: FB 9B BD isb $bd9b, y
91D9: 1A       nop
91DA: 03 29    slo ($29, x)
91DC: 7F C9 0A rra $0ac9, x
91DF: F0 04    beq $91e5
91E1: C9 0B    cmp #$0b
91E3: D0 09    bne $91ee
...
92E8: 10 0C    bpl $92f6
92EA: F0 92    beq $927e
92EC: 0E 93 2E asl $2e93
92EF: 93 A0    sha ($a0), y
92F1: 20 BD 37 jsr $37bd
92F4: 03 29    slo ($29, x)
92F6: 40       rti
92F7: F0 02    beq $92fb
92F9: A0 60    ldy #$60
...
9392: 18       clc
9393: 20 18 20 jsr $2018
9396: 20 28 18 jsr $1828
9399: 20 18 20 jsr $2018
939C: 18       clc
939D: 20 20 28 jsr $2820
93A0: 18       clc
93A1: 20 BD 1A jsr $1abd
93A4: 03 30    slo ($30, x)
93A6: 48       pha
...
9841: 14 20    nop $20, x
9843: 18       clc
9844: 20 18 20 jsr $2018
9847: 18       clc
9848: 20 18 00 jsr $0018
984B: 02       kil
984C: 00       brk
984D: 01 BD    ora ($bd, x)
984F: 1A       nop
...
9964: 20 18 20 jsr $2018
9967: 18       clc
9968: 20 18 20 jsr $2018
996B: 18       clc
996C: 00       brk
996D: 04 00    nop $00
996F: 01 BD    ora ($bd, x)
...
9C88: 00       brk
9C89: 00       brk
9C8A: FF FF FF isb $ffff, x
9C8D: FF 00 00 isb $0000, x
9C90: 00       brk
9C91: 00       brk
9C92: 00       brk
9C93: 00       brk
...
9C9F: 00       brk
9CA0: 00       brk
9CA1: FF 00 00 isb $0000, x
9CA4: 00       brk
9CA5: 00       brk
9CA6: FF FF 00 isb $00ff, x
9CA9: FF 00 47 isb $4700, x
9CAC: 9D 47 9D sta $9d47, x
9CAF: 47 9D    sre $9d
9CB1: 47 9D    sre $9d
9CB3: 47 9D    sre $9d
9CB5: 47 9D    sre $9d
...
9CCF: 4B 9D    asr #$9d
9CD1: 4B 9D    asr #$9d
9CD3: 4F 9D 4F sre $4f9d
9CD6: 9D 53 9D sta $9d53, x
9CD9: 53 9D    sre ($9d), y
9CDB: 57 9D    sre $9d, x
9CDD: 57 9D    sre $9d, x
9CDF: 5C 9D 5C nop $5c9d, x
9CE2: 9D 5D 9D sta $9d5d, x
9CE5: 5D 9D 61 eor $619d, x
9CE8: 9D 63 9D sta $9d63, x
9CEB: 66 9D    ror $9d
9CED: 66 9D    ror $9d
9CEF: 6A       ror a
9CF0: 9D 6A 9D sta $9d6a, x
9CF3: 6E 9D 6E ror $6e9d
9CF6: 9D 71 9D sta $9d71, x
9CF9: 71 9D    adc ($9d), y
9CFB: 71 9D    adc ($9d), y
9CFD: 71 9D    adc ($9d), y
9CFF: 75 9D    adc $9d, x
...
9D0F: 76 9D    ror $9d, x
9D11: 76 9D    ror $9d, x
9D13: 79 9D 79 adc $799d, y
9D16: 9D 7C 9D sta $9d7c, x
9D19: 7C 9D 7C nop $7c9d, x
9D1C: 9D 7C 9D sta $9d7c, x
9D1F: 80 9D    nop #$9d
9D21: 80 9D    nop #$9d
9D23: 80 9D    nop #$9d
9D25: 80 9D    nop #$9d
...
9D39: 87 9D    sax $9d
9D3B: 88       dey
9D3C: 9D 88 9D sta $9d88, x
9D3F: 89 9D    nop #$9d
9D41: 89 9D    nop #$9d
9D43: 8D 9D 8D sta $8d9d
9D46: 9D 04 04 sta $0404, x
9D49: 04 04    nop $04
9D4B: 03 03    slo ($03, x)
9D4D: 03 03    slo ($03, x)
9D4F: 04 04    nop $04
...
9D6A: 01 01    ora ($01, x)
9D6C: 02       kil
9D6D: FF 02 02 isb $0202, x
9D70: 04 01    nop $01
9D72: 01 04    ora ($04, x)
9D74: FF 10 04 isb $0410, x
9D77: 04 FF    nop $ff
9D79: 08       php
9D7A: 04 08    nop $08
9D7C: 02       kil
...
9E0F: 60       rts
9E10: AC 9E B4 ldy $b49e
9E13: 9E AC 9E shx $9eac, y
9E16: B4 9E    ldy $9e, x
9E18: AC 9E B4 ldy $b49e
9E1B: 9E BC 9E shx $9ebc, y
9E1E: BC 9E BC ldy $bc9e, x
9E21: 9E BC 9E shx $9ebc, y
9E24: BC 9E BC ldy $bc9e, x
9E27: 9E C4 9E shx $9ec4, y
9E2A: C4 9E    cpy $9e
9E2C: C4 9E    cpy $9e
9E2E: C4 9E    cpy $9e
9E30: C4 9E    cpy $9e
...
9E40: 24 9F    bit $9f
9E42: 24 9F    bit $9f
9E44: 4C 9F 4C jmp $4c9f
9E47: 9F 54 9F sha $9f54, y
9E4A: 54 9F    nop $9f, x
9E4C: 74 9F    nop $9f, x
9E4E: 84 9F    sty $9f
9E50: 9C 9F 9C shy $9c9f, x
9E53: 9F 9C 9F sha $9f9c, y
9E56: 9C 9F BC shy $bc9f, x
9E59: 9F BC 9F sha $9fbc, y
9E5C: D4 9F    nop $9f, x
9E5E: D4 9F    nop $9f, x
9E60: F4 9F    nop $9f, x
9E62: F4 9F    nop $9f, x
...
9F22: 42       kil
9F23: 18       clc
9F24: 19 1A 1B ora $1b1a, y
9F27: 1C 18 19 nop $1918, x
9F2A: 1A       nop
9F2B: 1B 1C 18 slo $181c, y
9F2E: 19 1A 1B ora $1b1a, y
9F31: 1C 18 19 nop $1918, x
9F34: 1A       nop
9F35: 1B 1C 18 slo $181c, y
9F38: 19 1A 1B ora $1b1a, y
9F3B: 1C 18 19 nop $1918, x
9F3E: 1A       nop
9F3F: 1B 1C 18 slo $181c, y
9F42: 19 1A 1B ora $1b1a, y
9F45: 1C 18 19 nop $1918, x
9F48: 1A       nop
9F49: 1B 1C 18 slo $181c, y
9F4C: 37 37    rla $37, x
9F4E: 39 3B 3B and $3b3b, y
9F51: 3B 39 37 rla $3739, y
9F54: 16 17    asl $17, x
9F56: 2E 18 16 rol $1618
9F59: 17 2E    slo $2e, x
9F5B: 18       clc
9F5C: 16 17    asl $17, x
9F5E: 2E 18 16 rol $1618
9F61: 17 2E    slo $2e, x
9F63: 18       clc
9F64: 16 17    asl $17, x
9F66: 2E 18 16 rol $1618
9F69: 17 2E    slo $2e, x
9F6B: 18       clc
9F6C: 16 17    asl $17, x
9F6E: 2E 18 16 rol $1618
9F71: 17 2E    slo $2e, x
9F73: 18       clc
9F74: 1D 1E 1D ora $1d1e, x
9F77: 1E 1D 1E asl $1e1d, x
9F7A: 1D 1E 1D ora $1d1e, x
9F7D: 1E 1D 1E asl $1e1d, x
9F80: 1D 1E 1D ora $1d1e, x
9F83: 1E 1D 1E asl $1e1d, x
9F86: 1F 1D 1E slo $1e1d, x
9F89: 1F 1D 1E slo $1e1d, x
9F8C: 1F 1D 1E slo $1e1d, x
9F8F: 1F 1D 1E slo $1e1d, x
9F92: 1F 1D 1E slo $1e1d, x
9F95: 1F 1D 1E slo $1e1d, x
9F98: 1F 1D 1E slo $1e1d, x
9F9B: 1F 1D 20 slo $201d, x
9F9E: 21 22    and ($22, x)
9FA0: 1D 20 21 ora $2120, x
9FA3: 22       kil
9FA4: 1D 20 21 ora $2120, x
9FA7: 22       kil
9FA8: 1D 20 21 ora $2120, x
9FAB: 22       kil
9FAC: 1D 20 21 ora $2120, x
9FAF: 22       kil
9FB0: 1D 20 21 ora $2120, x
9FB3: 22       kil
9FB4: 1D 20 21 ora $2120, x
9FB7: 22       kil
9FB8: 1D 20 21 ora $2120, x
9FBB: 22       kil
9FBC: 23 24    rla ($24, x)
9FBE: 25 23    and $23
9FC0: 24 25    bit $25
...
9FF5: 26 27    rol $27
9FF7: 28       plp
9FF8: 2C 26 27 bit $2726
9FFB: 28       plp
9FFC: 2C 26 27 bit $2726
9FFF: 28       plp
A000: 2C 26 27 bit $2726
A003: 28       plp
A004: 2C 26 27 bit $2726
A007: 28       plp
A008: 2C 26 27 bit $2726
A00B: 28       plp
A00C: 2C 26 27 bit $2726
A00F: 28       plp
A010: 2C 26 27 bit $2726
A013: 28       plp
A014: 2D 2D 2D and $2d2d
A017: 2D 2D 2D and $2d2d
A01A: 2D 2D 2C and $2c2d
A01D: 2C 2C 2C bit $2c2c
A020: 2C 2C 2C bit $2c2c
A023: 2C 2F 2F bit $2f2f
A026: 2F 2F 2F rla $2f2f
A029: 2F 2F 2F rla $2f2f
A02C: 2F 30 31 rla $3130
A02F: 2F 30 31 rla $3130
A032: 2F 30 31 rla $3130
A035: 2F 30 31 rla $3130
A038: 2F 30 31 rla $3130
A03B: 2F 30 31 rla $3130
A03E: 2F 30 31 rla $3130
A041: 2F 30 31 rla $3130
A044: 3C 3D 3E nop $3e3d, x
A047: 3C 3D 3E nop $3e3d, x
A04A: 3C 3D 3E nop $3e3d, x
A04D: 3C 3D 3E nop $3e3d, x
A050: 3C 3D 3E nop $3e3d, x
A053: 3C 3D 3E nop $3e3d, x
A056: 3C 3D 3E nop $3e3d, x
A059: 3C 3D 3E nop $3e3d, x
A05C: 32       kil
A05D: 33 34    rla ($34), y
A05F: 35 32    and $32, x
A061: 33 34    rla ($34), y
...
A089: 41 40    eor ($40, x)
A08B: 41 3F    eor ($3f, x)
A08D: 3F 3F 3F rla $3f3f, x
A090: 3F 3F 3F rla $3f3f, x
A093: 3F 44 44 rla $4444, x
A096: 43 43    sre ($43, x)
A098: 43 43    sre ($43, x)
A09A: 43 44    sre ($44, x)
A09C: 16 16    asl $16, x
...
A0B8: 14 14    nop $14, x
A0BA: 15 14    ora $14, x
A0BC: 0C 0D 0C nop $0c0d
A0BF: 0D 0C 0D ora $0d0c
A0C2: 0C 0D 0C nop $0c0d
A0C5: 0D 0C 0D ora $0d0c
A0C8: 0C 0D 0C nop $0c0d
A0CB: 0D 0E 0E ora $0e0e
A0CE: 0E 0E 0E asl $0e0e
A0D1: 0E 0E 0E asl $0e0e
A0D4: 0F 0F 0F slo $0f0f
A0D7: 0F 0F 0F slo $0f0f
A0DA: 0F 0F 36 slo $360f
A0DD: 36 38    rol $38, x
A0DF: 3A       nop
A0E0: 3A       nop
A0E1: 3A       nop
...
A0E5: F1 F0    sbc ($f0), y
A0E7: 13 BD    slo ($bd), y
A0E9: 0E 03 29 asl $2903
A0EC: 7F 9D 0E rra $0e9d, x
A0EF: 03 A9    slo ($a9, x)
A0F1: 00       brk
A0F2: 95 D5    sta $d5, x
A0F4: 95 E3    sta $e3, x
...
A333: 0A       asl a
A334: AA       tax
A335: BD D3 A3 lda $a3d3, x
A338: 85 1B    sta $1b
A33A: BD D4 A3 lda $a3d4, x
A33D: 85 1C    sta $1c
A33F: A6 4C    ldx $4c
A341: 6C 1B 00 jmp ($001b)
...
A3D3: E1 A3    sbc ($a3, x)
A3D5: EE A3 FD inc $fda3
A3D8: A3 00    lax ($00, x)
A3DA: A4 03    ldy $03
A3DC: A4 06    ldy $06
A3DE: A4 15    ldy $15
A3E0: A4 B9    ldy $b9
A3E2: 0E 03 29 asl $2903
A3E5: 10 D0    bpl $a3b7
A3E7: 03 20    slo ($20, x)
A3E9: 29 A6    and #$a6
...
A4A4: 00       brk
A4A5: 00       brk
A4A6: FF FF FF isb $ffff, x
A4A9: FF 00 02 isb $0200, x
A4AC: 01 02    ora ($02, x)
A4AE: 02       kil
A4AF: 02       kil
A4B0: 02       kil
...
A64E: 0A       asl a
A64F: A8       tay
A650: B9 5E A6 lda $a65e, y
A653: 85 1B    sta $1b
A655: B9 5F A6 lda $a65f, y
A658: 85 1C    sta $1c
A65A: 6C 1B 00 jmp ($001b)
A65D: 60       rts
A65E: 68       pla
A65F: A6 A8    ldx $a8
A661: A6 A8    ldx $a8
...
A703: 0B A7    anc #$a7
A705: 0F A7 15 slo $15a7
A708: A7 19    lax $19
A70A: A7 80    lax $80
A70C: 81 80    sta ($80, x)
A70E: FF 80 81 isb $8180, x
A711: 80 82    nop #$82
A713: 80 FF    nop #$ff
A715: 80 82    nop #$82
A717: 80 FF    nop #$ff
...
A739: 0A       asl a
A73A: A8       tay
A73B: B9 49 A7 lda $a749, y
A73E: 85 00    sta $00
A740: B9 4A A7 lda $a74a, y
A743: 85 01    sta $01
A745: 6C 00 00 jmp ($0000)
A748: 60       rts
A749: 51 A7    eor ($a7), y
A74B: 91 A7    sta ($a7), y
A74D: B8       clv
...
A990: 8B D0    ane #$d0
A992: 8B A8    ane #$a8
A994: 8C D0 8B sty $8bd0
A997: A8       tay
A998: 8D D0 8B sta $8bd0
A99B: A8       tay
A99C: 8E D0 8B stx $8bd0
A99F: A8       tay
A9A0: 8F D0 85 sax $85d0
A9A3: 1B 8A 48 slo $488a, y
A9A6: 98       tya
A9A7: 48       pha
A9A8: A5 4C    lda $4c
A9AA: 18       clc
...
AA8C: 60       rts
AA8D: 00       brk
AA8E: FF 00 00 isb $0000, x
AA91: FF 00 08 isb $0800, x
AA94: FF 38 F8 isb $f838, x
AA97: FF 38 00 isb $0038, x
AA9A: FF 00 F0 isb $f000, x
AA9D: FF 20 F8 isb $f820, x
AAA0: FF 28 00 isb $0028, x
AAA3: FF 00 D8 isb $d800, x
AAA6: FF 10 E0 isb $e010, x
AAA9: FF 18 C8 isb $c818, x
AAAC: FF 08 10 isb $1008, x
AAAF: FF 40 0C isb $0c40, x
AAB2: FF 40 00 isb $0040, x
AAB5: FF 00 0C isb $0c00, x
AAB8: FF 18 0C isb $0c18, x
AABB: FF 08 00 isb $0008, x
AABE: FF F8 08 isb $08f8, x
AAC1: FF 20 08 isb $0820, x
AAC4: FF 10 00 isb $0010, x
AAC7: FF 0C 10 isb $100c, x
AACA: FF 14 0C isb $0c14, x
AACD: FF 20 F8 isb $f820, x
AAD0: FF 48 00 isb $0048, x
AAD3: FF 00 00 isb $0000, x
AAD6: FF 00 00 isb $0000, x
AAD9: FF 00 00 isb $0000, x
AADC: FF 00 08 isb $0800, x
AADF: FF 48 F8 isb $f848, x
AAE2: FF 48 00 isb $0048, x
AAE5: FF 00 00 isb $0000, x
AAE8: FF 00 00 isb $0000, x
AAEB: FF 50 00 isb $0050, x
AAEE: FF 00 F8 isb $f800, x
AAF1: FF 48 00 isb $0048, x
AAF4: FF 00 00 isb $0000, x
AAF7: FF 50 00 isb $0050, x
AAFA: FF 00 F8 isb $f800, x
AAFD: FF 20 00 isb $0020, x
AB00: FF 00 00 isb $0000, x
AB03: FF 00 00 isb $0000, x
AB06: FF 00 00 isb $0000, x
AB09: FF 00 00 isb $0000, x
AB0C: FF 00 00 isb $0000, x
AB0F: FF 00 00 isb $0000, x
AB12: FF 00 00 isb $0000, x
AB15: FF 00 00 isb $0000, x
AB18: FF 00 00 isb $0000, x
AB1B: FF 00 A2 isb $a200, x
AB1E: 07 86    slo $86
AB20: 4C A6 4C jmp $4ca6
...
ABBA: 83 82    sax ($82, x)
ABBC: 83 82    sax ($82, x)
ABBE: FF 84 84 isb $8484, x
ABC1: 84 84    sty $84
ABC3: 85 85    sta $85
ABC5: 85 85    sta $85
ABC7: 84 84    sty $84
ABC9: 84 84    sty $84
ABCB: FF 86 86 isb $8686, x
ABCE: 86 86    stx $86
ABD0: 87 87    sax $87
ABD2: 87 87    sax $87
ABD4: 86 86    stx $86
ABD6: 86 86    stx $86
ABD8: FF 88 88 isb $8888, x
ABDB: 88       dey
ABDC: 88       dey
ABDD: 89 89    nop #$89
ABDF: 89 89    nop #$89
...
ABE3: 88       dey
ABE4: 88       dey
ABE5: FF 8A 8A isb $8a8a, x
ABE8: 8B 8B    ane #$8b
ABEA: 8C 8C 8D sty $8d8c
ABED: 8D FF 8E sta $8eff
ABF0: 8E 8F 8F stx $8f8f
ABF3: 90 90    bcc $ab85
ABF5: 91 91    sta ($91), y
ABF7: FF 8A 48 isb $488a, x
ABFA: 98       tya
ABFB: 48       pha
ABFC: 8A       txa
ABFD: 85 1B    sta $1b
...
AD06: D0 BC    bne $acc4
AD08: 60       rts
AD09: 1B AD 1B slo $1bad, y
AD0C: AD 32 AD lda $ad32
AD0F: 5F AD 1B sre $1bad, x
AD12: AD 1B AD lda $ad1b
AD15: 32       kil
AD16: AD 5F AD lda $ad5f
AD19: 76 AD    ror $ad, x
AD1B: 27 96    rla $96
AD1D: 00       brk
AD1E: 78       sei
...
AD26: 27 95    rla $95
AD28: 00       brk
AD29: 9D 01 00 sta $0001, x
AD2C: BF 00 00 lax $0000, y
AD2F: 00       brk
AD30: 00       brk
AD31: FF 29 81 isb $8129, x
AD34: 00       brk
AD35: 97 00    sax $00, y
AD37: 00       brk
AD38: FE 00 00 inc $0000, x
AD3B: 00       brk
AD3C: 00       brk
AD3D: 29 82    and #$82
AD3F: 00       brk
AD40: CF 00 00 dcp $0000
AD43: 06 01    asl $01
AD45: 00       brk
AD46: 00       brk
AD47: 00       brk
...
AD53: 27 97    rla $97
AD55: 00       brk
AD56: 5F 01 00 sre $0001, x
AD59: D0 00    bne $ad5b
AD5B: 00       brk
AD5C: 00       brk
AD5D: 00       brk
AD5E: FF 2C 80 isb $802c, x
AD61: 00       brk
AD62: 2F 01 00 rla $0001
AD65: 06 01    asl $01
AD67: 00       brk
AD68: 00       brk
AD69: 00       brk
...
AD6D: D8       cld
AD6E: 01 00    ora ($00, x)
AD70: FE 00 00 inc $0000, x
AD73: 00       brk
AD74: 00       brk
AD75: FF 2E 80 isb $802e, x
AD78: 00       brk
AD79: 40       rti
AD7A: 01 00    ora ($00, x)
AD7C: 0D 01 00 ora $0001
AD7F: 00       brk
AD80: 00       brk
AD81: FF A2 07 isb $07a2, x
AD84: 86 4C    stx $4c
AD86: A6 4C    ldx $4c
...
B718: 00       brk
B719: 00       brk
B71A: FF FF FF isb $ffff, x
B71D: FF 00 85 isb $8500, x
B720: 1B 8A 48 slo $488a, y
B723: 98       tya
B724: 48       pha
B725: A6 1B    ldx $1b
B727: A9 00    lda #$00
...
B77F: 0A       asl a
B780: A8       tay
B781: B9 A7 B7 lda $b7a7, y
B784: 85 1B    sta $1b
B786: B9 A8 B7 lda $b7a8, y
B789: 85 1C    sta $1c
B78B: 6C 1B 00 jmp ($001b)
B78E: A9 01    lda #$01
B790: 85 1B    sta $1b
...
B8A5: 10 06    bpl $b8ad
B8A7: 22       kil
B8A8: 20 20 08 jsr $0820
B8AB: 08       php
B8AC: 77 14    rra $14, x
B8AE: 3C AF 16 nop $16af, x
B8B1: 3A       nop
B8B2: AF 2D 2F lax $2f2d
B8B5: A3 2F    lax ($2f, x)
B8B7: 2D A3 0F and $0fa3
B8BA: 0D 0E 0F ora $0f0e
B8BD: 0D 0B 0F ora $0f0b
B8C0: 0D 09 0F ora $0f09
B8C3: 0D 0C 0E ora $0e0c
B8C6: 0B 19    anc #$19
B8C8: 1C 1F 31 nop $311f, x
B8CB: 0D 3B 30 ora $303b
B8CE: 30 26    bmi $b8f6
B8D0: 32       kil
B8D1: 0A       asl a
B8D2: 36 30    rol $30, x
B8D4: 30 2D    bmi $b903
B8D6: 2F 0B 31 rla $310b
B8D9: 30 30    bmi $b90b
B8DB: 0F 0D 0A slo $0a0d
B8DE: 08       php
B8DF: 05 02    ora $02
B8E1: 0F 0D 0A slo $0a0d
B8E4: 07 04    slo $04
B8E6: 01 0F    ora ($0f, x)
B8E8: 0D 0A 06 ora $060a
B8EB: 03 00    slo ($00, x)
B8ED: 17 18    slo $18, x
B8EF: 59 18 1E eor $1e18, y
B8F2: 38       sec
B8F3: 5E 38 26 lsr $2638, x
B8F6: 58       cli
B8F7: 63 58    rra ($58, x)
B8F9: 10 38    bpl $b933
B8FB: 0A       asl a
...
B906: 0B 02    anc #$02
B908: 01 10    ora ($10, x)
B90A: 19 1C 1F ora $1f1c, y
B90D: 11 85    ora ($85), y
B90F: 1B 98 48 slo $4898, y
B912: A5 1B    lda $1b
B914: C9 00    cmp #$00
B916: F0 3D    beq $b955
B918: 8A       txa
...
B994: 50 50    bvc $b9e6
B996: 45 55    eor $55
B998: 99 00 95 sta $9500, y
B99B: 05 75    ora $75
B99D: 25 85    and $85
B99F: 15 80    ora $80, x
B9A1: 20 80 20 jsr $2080
B9A4: 80 20    nop #$20
B9A6: 99 00 00 sta $0000, y
B9A9: 00       brk
B9AA: 99 00 00 sta $0000, y
B9AD: 00       brk
B9AE: 60       rts
B9AF: 25 10    and $10
B9B1: 05 60    ora $60
...
B9DD: 15 30    ora $30, x
B9DF: 30 20    bmi $ba01
B9E1: 20 30 30 jsr $3030
B9E4: 20 20 25 jsr $2520
B9E7: 30 25    bmi $ba0e
B9E9: 20 25 30 jsr $3025
B9EC: 25 20    and $20
B9EE: 20 30 25 jsr $2530
B9F1: 25 20    and $20
B9F3: 30 25    bmi $ba1a
B9F5: 25 15    and $15
B9F7: 30 25    bmi $ba1e
...
BA7D: 0A       asl a
BA7E: A8       tay
BA7F: B9 8C BA lda $ba8c, y
BA82: 85 10    sta $10
BA84: B9 8D BA lda $ba8d, y
BA87: 85 11    sta $11
BA89: 6C 10 00 jmp ($0010)
BA8C: AE BA AE ldx $aeba
BA8F: BA       tsx
BA90: AE BA AE ldx $aeba
BA93: BA       tsx
BA94: AE BA AE ldx $aeba
BA97: BA       tsx
BA98: AE BA AE ldx $aeba
BA9B: BA       tsx
BA9C: AE BA AE ldx $aeba
BA9F: BA       tsx
BAA0: F5 BB    sbc $bb, x
BAA2: F5 BB    sbc $bb, x
BAA4: AE BA AE ldx $aeba
BAA7: BA       tsx
...
BE07: 0A       asl a
BE08: A8       tay
BE09: B9 61 BE lda $be61, y
BE0C: 85 10    sta $10
BE0E: B9 62 BE lda $be62, y
BE11: 85 11    sta $11
BE13: 6C 10 00 jmp ($0010)
BE16: A5 4F    lda $4f
BE18: 10 41    bpl $be5b
BE1A: A5 53    lda $53
BE1C: C9 04    cmp #$04
...
BE5F: 68       pla
BE60: 60       rts
BE61: 0E C5 66 asl $66c5
BE64: C4 8A    cpy $8a
BE66: BE 5C C0 ldx $c05c, y
BE69: 5C C0 5C nop $5cc0, x
BE6C: C0 5C    cpy #$5c
BE6E: C0 5C    cpy #$5c
BE70: C0 5C    cpy #$5c
BE72: C0 5C    cpy #$5c
...
BE7A: C0 DD    cpy #$dd
BE7C: C4 15    cpy $15
BE7E: BF 83 BE lax $be83, y
BE81: 8A       txa
BE82: BE A2 50 ldx $50a2, y
BE85: A9 02    lda #$02
...
C04D: 26 01    rol $01
C04F: 26 FF    rol $ff
C051: FF FF FF isb $ffff, x
C054: FF FF 02 isb $02ff, x
C057: 26 03    rol $03
C059: 27 03    rla $03
C05B: 27 E6    rla $e6
C05D: 53 A9    sre ($a9), y
...
C1A4: 26 C4    rol $c4
C1A6: 00       brk
C1A7: 99 00 99 sta $9900, y
C1AA: 00       brk
C1AB: 99 40 60 sta $6040, y
C1AE: 00       brk
C1AF: 99 10 90 sta $9010, y
C1B2: 20 80 50 jsr $5080
C1B5: 50 00    bvc $c1b7
C1B7: 99 15 85 sta $8515, y
C1BA: 30 70    bmi $c22c
C1BC: 60       rts
C1BD: 40       rti
C1BE: 00       brk
C1BF: 99 20 80 sta $8020, y
C1C2: 40       rti
C1C3: 60       rts
C1C4: 70 30    bvs $c1f6
C1C6: 00       brk
C1C7: 99 15 85 sta $8515, y
C1CA: 30 70    bmi $c23c
C1CC: 60       rts
C1CD: 40       rti
C1CE: 00       brk
C1CF: 99 15 85 sta $8515, y
C1D2: 30 70    bmi $c244
C1D4: 60       rts
C1D5: 40       rti
C1D6: 00       brk
C1D7: 99 08 92 sta $9208, y
C1DA: 15 85    ora $85, x
C1DC: 55 45    eor $45, x
C1DE: 00       brk
C1DF: 99 08 92 sta $9208, y
C1E2: 15 85    ora $85, x
C1E4: 55 45    eor $45, x
C1E6: 40       rti
C1E7: 60       rts
C1E8: 60       rts
C1E9: 40       rti
C1EA: 99 00 99 sta $9900, y
C1ED: 00       brk
C1EE: 60       rts
C1EF: 40       rti
C1F0: 80 20    nop #$20
C1F2: 99 00 99 sta $9900, y
C1F5: 00       brk
C1F6: 80 20    nop #$20
C1F8: 99 00 99 sta $9900, y
C1FB: 00       brk
C1FC: 99 00 99 sta $9900, y
C1FF: 00       brk
C200: 99 00 99 sta $9900, y
C203: 00       brk
C204: 99 00 80 sta $8000, y
C207: 20 99 00 jsr $0099
C20A: 99 00 99 sta $9900, y
C20D: 00       brk
C20E: 80 20    nop #$20
C210: 99 00 99 sta $9900, y
C213: 00       brk
C214: 99 00 50 sta $5000, y
C217: 50 70    bvc $c289
C219: 30 99    bmi $c1b4
C21B: 00       brk
C21C: 99 00 50 sta $5000, y
C21F: 50 70    bvc $c291
C221: 30 99    bmi $c1bc
C223: 00       brk
C224: 99 00 10 sta $1000, y
C227: 90 20    bcc $c249
C229: 80 60    nop #$60
C22B: 40       rti
C22C: 80 20    nop #$20
C22E: 20 80 30 jsr $3080
C231: 70 70    bvs $c2a3
C233: 30 90    bmi $c1c5
C235: 10 30    bpl $c267
C237: 70 40    bvs $c279
C239: 60       rts
C23A: 80 20    nop #$20
C23C: 99 00 40 sta $4000, y
C23F: 60       rts
C240: 50 50    bvc $c292
C242: 90 10    bcc $c254
C244: 99 00 30 sta $3000, y
C247: 70 40    bvs $c289
C249: 60       rts
C24A: 80 20    nop #$20
C24C: 99 00 30 sta $3000, y
C24F: 70 40    bvs $c291
C251: 60       rts
C252: 80 20    nop #$20
C254: 99 00 15 sta $1500, y
C257: 85 25    sta $25
C259: 75 65    adc $65, x
C25B: 35 85    and $85, x
C25D: 15 15    ora $15, x
...
C2A3: 55 65    eor $65, x
C2A5: 35 00    and $00, x
C2A7: 99 10 90 sta $9010, y
C2AA: 40       rti
C2AB: 60       rts
C2AC: 60       rts
C2AD: 40       rti
C2AE: 10 90    bpl $c240
C2B0: 20 80 50 jsr $5080
C2B3: 50 70    bvc $c325
C2B5: 30 20    bmi $c2d7
C2B7: 80 30    nop #$30
C2B9: 70 60    bvs $c31b
...
C2C2: 70 30    bvs $c2f4
C2C4: 90 10    bcc $c2d6
C2C6: 20 80 30 jsr $3080
C2C9: 70 60    bvs $c32b
C2CB: 40       rti
C2CC: 80 20    nop #$20
C2CE: 20 80 30 jsr $3080
C2D1: 70 60    bvs $c333
C2D3: 40       rti
C2D4: 80 20    nop #$20
C2D6: 05 95    ora $95
...
C2E4: 65 35    adc $35
C2E6: 00       brk
C2E7: 99 00 99 sta $9900, y
C2EA: 30 70    bmi $c35c
C2EC: 50 50    bvc $c33e
C2EE: 00       brk
C2EF: 99 10 90 sta $9010, y
C2F2: 40       rti
C2F3: 60       rts
C2F4: 60       rts
C2F5: 40       rti
C2F6: 10 90    bpl $c288
C2F8: 20 80 50 jsr $5080
C2FB: 50 70    bvc $c36d
C2FD: 30 20    bmi $c31f
C2FF: 80 30    nop #$30
C301: 70 60    bvs $c363
...
C313: 50 70    bvc $c385
C315: 30 00    bmi $c317
C317: 99 05 95 sta $9505, y
C31A: 35 65    and $65, x
C31C: 55 45    eor $45, x
C31E: 00       brk
C31F: 99 05 95 sta $9505, y
C322: 35 65    and $65, x
C324: 55 45    eor $45, x
C326: 00       brk
C327: 99 00 99 sta $9900, y
C32A: 20 80 40 jsr $4080
C32D: 60       rts
C32E: 00       brk
C32F: 99 00 99 sta $9900, y
C332: 30 70    bmi $c3a4
C334: 50 50    bvc $c386
C336: 00       brk
C337: 99 10 90 sta $9010, y
C33A: 40       rti
C33B: 60       rts
C33C: 60       rts
C33D: 40       rti
C33E: 10 90    bpl $c2d0
C340: 20 80 50 jsr $5080
C343: 50 70    bvc $c3b5
C345: 30 00    bmi $c347
C347: 99 10 90 sta $9010, y
C34A: 40       rti
C34B: 60       rts
C34C: 60       rts
C34D: 40       rti
C34E: 00       brk
C34F: 99 10 90 sta $9010, y
C352: 40       rti
C353: 60       rts
C354: 60       rts
C355: 40       rti
C356: 00       brk
C357: 99 00 99 sta $9900, y
C35A: 25 75    and $75
C35C: 45 55    eor $55
C35E: 00       brk
C35F: 99 00 99 sta $9900, y
C362: 25 75    and $75
C364: 45 55    eor $55
C366: 00       brk
C367: 99 00 99 sta $9900, y
C36A: 10 90    bpl $c2fc
C36C: 30 70    bmi $c3de
C36E: 00       brk
C36F: 99 00 99 sta $9900, y
C372: 20 80 40 jsr $4080
C375: 60       rts
C376: 00       brk
C377: 99 00 99 sta $9900, y
C37A: 30 70    bmi $c3ec
C37C: 50 50    bvc $c3ce
C37E: 00       brk
C37F: 99 10 90 sta $9010, y
C382: 40       rti
C383: 60       rts
C384: 60       rts
C385: 40       rti
C386: 00       brk
C387: 99 00 99 sta $9900, y
C38A: 30 70    bmi $c3fc
C38C: 50 50    bvc $c3de
C38E: 00       brk
C38F: 99 00 99 sta $9900, y
C392: 30 70    bmi $c404
C394: 50 50    bvc $c3e6
C396: 00       brk
C397: 99 00 99 sta $9900, y
C39A: 15 85    ora $85, x
C39C: 35 65    and $65, x
C39E: 00       brk
C39F: 99 00 99 sta $9900, y
C3A2: 15 85    ora $85, x
C3A4: 35 65    and $65, x
C3A6: 00       brk
C3A7: 99 00 99 sta $9900, y
C3AA: 00       brk
C3AB: 99 20 80 sta $8020, y
C3AE: 00       brk
C3AF: 99 00 99 sta $9900, y
C3B2: 10 90    bpl $c344
C3B4: 30 70    bmi $c426
C3B6: 00       brk
C3B7: 99 00 99 sta $9900, y
C3BA: 20 80 40 jsr $4080
C3BD: 60       rts
C3BE: 00       brk
C3BF: 99 00 99 sta $9900, y
C3C2: 30 70    bmi $c434
C3C4: 50 50    bvc $c416
C3C6: 00       brk
C3C7: 99 00 99 sta $9900, y
C3CA: 20 80 40 jsr $4080
C3CD: 60       rts
C3CE: 00       brk
C3CF: 99 00 99 sta $9900, y
C3D2: 20 80 40 jsr $4080
C3D5: 60       rts
C3D6: 00       brk
C3D7: 99 00 99 sta $9900, y
C3DA: 05 95    ora $95
C3DC: 25 75    and $75
C3DE: 00       brk
C3DF: 99 00 99 sta $9900, y
C3E2: 05 95    ora $95
C3E4: 25 75    and $75
C3E6: 00       brk
C3E7: 99 00 99 sta $9900, y
C3EA: 00       brk
C3EB: 99 10 90 sta $9010, y
C3EE: 00       brk
C3EF: 99 00 99 sta $9900, y
C3F2: 00       brk
C3F3: 99 20 80 sta $8020, y
C3F6: 00       brk
C3F7: 99 00 99 sta $9900, y
C3FA: 10 90    bpl $c38c
C3FC: 30 70    bmi $c46e
C3FE: 00       brk
C3FF: 99 00 99 sta $9900, y
C402: 20 80 40 jsr $4080
C405: 60       rts
C406: 00       brk
C407: 99 00 99 sta $9900, y
C40A: 10 90    bpl $c39c
C40C: 30 70    bmi $c47e
C40E: 00       brk
C40F: 99 00 99 sta $9900, y
C412: 10 90    bpl $c3a4
C414: 30 70    bmi $c486
C416: 00       brk
C417: 99 00 99 sta $9900, y
C41A: 00       brk
C41B: 99 15 85 sta $8515, y
C41E: 00       brk
C41F: 99 00 99 sta $9900, y
C422: 00       brk
C423: 99 15 85 sta $8515, y
C426: 00       brk
C427: 99 00 99 sta $9900, y
C42A: 00       brk
C42B: 99 00 99 sta $9900, y
C42E: 00       brk
C42F: 99 00 99 sta $9900, y
C432: 00       brk
C433: 99 10 90 sta $9010, y
C436: 00       brk
C437: 99 00 99 sta $9900, y
C43A: 00       brk
C43B: 99 20 80 sta $8020, y
C43E: 00       brk
C43F: 99 00 99 sta $9900, y
C442: 10 90    bpl $c3d4
C444: 30 70    bmi $c4b6
C446: 00       brk
C447: 99 00 99 sta $9900, y
C44A: 00       brk
C44B: 99 20 80 sta $8020, y
C44E: 00       brk
C44F: 99 00 99 sta $9900, y
C452: 00       brk
C453: 99 20 80 sta $8020, y
C456: 00       brk
C457: 99 00 99 sta $9900, y
C45A: 00       brk
C45B: 99 05 95 sta $9505, y
C45E: 00       brk
C45F: 99 00 99 sta $9900, y
C462: 00       brk
...
D8DE: 60       rts
D8DF: 85 00    sta $00
D8E1: AD 2D 02 lda $022d
D8E4: 29 F8    and #$f8
D8E6: 05 00    ora $00
D8E8: 8D 2D 02 sta $022d
...
E1A5: 08       php
E1A6: 10 18    bpl $e1c0
E1A8: 20 28 30 jsr $3028
E1AB: 30 20    bmi $e1cd
E1AD: 20 20 20 jsr $2020
E1B0: 20 20 20 jsr $2020
E1B3: 20 28 A9 jsr $a928
E1B6: 01 20    ora ($20, x)
E1B8: DF D8 A5 dcp $a5d8, x
E1BB: 4C AA 0A jmp $0aaa
E1BE: A8       tay
E1BF: 85 0B    sta $0b
E1C1: E0 0D    cpx #$0d
E1C3: 90 07    bcc $e1cc
...
E764: 60       rts
E765: C3 BA    dcp ($ba, x)
E767: BB BC BD las $bdbc, y
E76A: BE BF C0 ldx $c0bf, y
E76D: C1 C2    cmp ($c2, x)
E76F: A5 57    lda $57
E771: C5 59    cmp $59
E773: D0 07    bne $e77c
...
E894: C7 CE    dcp $ce
E896: C8       iny
E897: CF C9 D0 dcp $d0c9
E89A: CA       dex
E89B: D1 CB    cmp ($cb), y
E89D: D2       kil
E89E: CC D3 CD cpy $cdd3
E8A1: D4 D5    nop $d5, x
E8A3: D8       cld
E8A4: D6 D9    dec $d9, x
E8A6: C6 C6    dec $c6
...
E8CE: A3 A8    lax ($a8, x)
E8D0: AB A8    lxa #$a8
E8D2: AD A8 A0 lda $a0a8
E8D5: AA       tax
E8D6: B2       kil
E8D7: AA       tax
E8D8: B8       clv
E8D9: AB A0    lxa #$a0
E8DB: AC A4 AC ldy $aca4
E8DE: A3 AC    lax ($ac, x)
E8E0: A0 AC    ldy #$ac
E8E2: A8       tay
E8E3: AC AD AC ldy $acad
E8E6: B2       kil
E8E7: AC AE AC ldy $acae
E8EA: B3 AD    lax ($ad), y
E8EC: A4 AD    ldy $ad
E8EE: B5 AD    lda $ad, x
E8F0: A7 AD    lax $ad
E8F2: A9 AD    lda #$ad
E8F4: AC AD B8 ldy $b8ad
E8F7: AD A2 AD lda $ada2
E8FA: A3 AE    lax ($ae, x)
E8FC: A7 AE    lax $ae
E8FE: AA       tax
E8FF: AE B1 AF ldx $afb1
E902: A0 B1    ldy #$b1
E904: A8       tay
E905: B2       kil
E906: A2 B2    ldx #$b2
E908: A3 B3    lax ($b3, x)
E90A: AD B3 B7 lda $b7b3
E90D: B4 B3    ldy $b3, x
E90F: B5 B3    lda $b3, x
E911: B5 A0    lda $a0, x
E913: B6 A0    ldx $a0, y
...
EAFA: AD 2D 02 lda $022d
EAFD: 09 40    ora #$40
EAFF: 8D 09 10 sta bankswitch_1009
EB02: 8D 2D 02 sta $022d
EB05: 60       rts
...
EB2B: F0 14    beq $eb41
EB2D: AD 2D 02 lda $022d
EB30: 29 BF    and #$bf
EB32: 8D 2D 02 sta $022d
EB35: 8D 09 10 sta bankswitch_1009
EB38: AD E0 07 lda $07e0
EB3B: 49 FF    eor #$ff
EB3D: 8D 0E 10 sta $100e
EB40: 60       rts
EB41: AD 2D 02 lda $022d
EB44: 09 40    ora #$40
EB46: 8D 2D 02 sta $022d
...
EB6C: AD 2D 02 lda $022d
EB6F: 29 BF    and #$bf
EB71: 8D 09 10 sta bankswitch_1009
EB74: 8D 2D 02 sta $022d
...
EB8B: AD 2D 02 lda $022d
EB8E: 29 DF    and #$df
EB90: 19 DE EB ora $ebde, y
EB93: 8D 2D 02 sta $022d
...
EBB9: AD 2D 02 lda $022d
EBBC: 09 40    ora #$40
EBBE: 8D 09 10 sta bankswitch_1009
EBC1: 8D 2D 02 sta $022d
EBC4: 60       rts
EBC5: FC 80 FC nop $fc80, x
EBC8: 02       kil
EBC9: 00       brk
EBCA: 02       kil
EBCB: 00       brk
EBCC: 04 08    nop $08
EBCE: 0C 10 1C nop $1c10
EBD1: 18       clc
EBD2: 18       clc
EBD3: 18       clc
EBD4: 14 14    nop $14, x
EBD6: 1C 1C 18 nop $181c, x
EBD9: 18       clc
EBDA: 1C 1C 1C nop $1c1c, x
EBDD: 00       brk
EBDE: 00       brk
EBDF: 00       brk
EBE0: 00       brk
EBE1: 00       brk
EBE2: 00       brk
EBE3: 20 20 20 jsr $2020
EBE6: 20 20 20 jsr $2020
EBE9: 20 20 20 jsr $2020
EBEC: 20 20 20 jsr $2020
EBEF: 20 00 A9 jsr $a900
EBF2: 0A       asl a
