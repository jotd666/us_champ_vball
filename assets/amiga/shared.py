...
def get_sprite_groups():
    rval = {0X52:0x58,0x50:0x56,0x10C:0x112,0X100:0x106,0X10A:0x110,0x102:0x108,0x11C:0x11C+6,0x11E:0x11E+6,0x126:0x126+6}
    # paired with +1
    for s in [0x28E,0x304,0x54,0X408,0x412,0X358,0x7CC,0x7CE,0X10E,0x120,0X104,0x4B8,0x22E,0x5C0,0X64C,0x638,0X652,0x658,0X744,0X746,0X748,0x752,0xE4,0xEA,0xB4,0x556,0X65E,0X59A,0x5B6,0x5A4,0XDE,0X5E8,0x57D,0x5dc,0x6da,0x76a,0x524,0x26,0x21A,0x21C,0x12A,0x5E0]:
        rval[s] = s+1
    # paired with +2
    for s in [0x300,0x296,0X7D5,0x60,0X2CA,0x2D2,0X7D4,0x182,0x17C,0x7C8,0x7D0,0x7D1,0X2AC,0X17A,0x79E,0X7A2,0X18A,0x648,0X478,0X222,0x223,0X22,0x738,0X73C,0x18E,0x64E,0x654,0X740,0X634,0x582,0X474,0X65A,0x58A,0x5EF,0x5EE,0X46B,0x655,0X65B,0X465,0x466,0X470,0x471,0x74C,0x735,0X217,0X187,0X58d,0X216,0x5dd,
    0x47c,0x46A,0x186,0x734,0x5DC,0x5EA,0x5EB]:
        rval[s] = s+2
    # paired with +4 (not the most interesting work to do... identify pairs manually...)
    for s in [0X1B2,0x1B4,0X250,0X261,0X38E,0x3B3,0X2A2,0X1D4,0x1D6,0x1AA,0x1AC,0x290,0x27E,0X270,0x165,0X386,0X280,0x260,0X390,0x164,0X7F3,0x7FB,0X7EB,0x3DB,0x3E3,0X23A,0X3EB,0X3E2,0x3CA,0X3B2,0X3BA,0X3C2,0X364,0x350,0X64,0x34A,0x35A,0X7F2,0X7FA,0X3EA,0X3DA,0x342,
