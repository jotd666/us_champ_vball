...
def get_sprite_groups():
    rval = {0x3F2:0x3F8,0X128:0x12E,0X52:0x58,0x50:0x56,0x10C:0x112,0X100:0x106,0X10A:0x110,0x102:0x108,0x11C:0x11C+6,0x11E:0x11E+6,0x126:0x126+6}
    # paired with +1
    for s in [0X322,0x30A,0x31C,0x3F4,0xD8,0x25C,0x424,0xD2,0x5D0,0x49A,0x49C,0x4AE,0x664,0x646,0x5D8,0x4FA,0X4A2,0x4AC,0X2F7,0x2F9,0x2FB,0xF0,0x28E,0x304,0x54,0X408,0x412,0X358,0x7CC,0x7CE,0X10E,0x120,0X104,0x4B8,0x22E,0x5C0,0X64C,0x638,0X652,0x658,0X744,0X746,0X748,0xE4,0xEA,0xB4,0x556,0X65E,0X59A,0x5B6,0x5A4,0XDE,0X5E8,0x57D,0x5dc,0x6da,0x76a,0x524,0x26,0x21A,0x21C,0x12A,0x5E0]:
        rval[s] = s+1
    # paired with +2
    for s in [0x318,0x312,0X1EE,0x324,0X30C,0x32A,0x7C2,0X2C2,0x2C6,0x2B6,0x2BA,0X306,0X7BA,0X2A4,0x2CE,0x520,0x490,0x494,0x66C,
    ...
    for s in [0X145,0X6A5,0X41C,0x426,0x51A,0x23B,0x6A4,0x3C3,0x3CB,0x1EE,0xD0,0x1DC,0x1E4,0x1EC,0x1F4,0x1F6,0x3D2,0x3D3,0x61A,0X502,0x50A,0x4F2,0XD6,0x512,0X600,0x602,0x620,0x622,0x192,0x194,0x4F4,0xEE,0xF4,0xFA,0X1B2,
