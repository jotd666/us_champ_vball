...
def get_sprite_groups():
    ...
    # paired with +1
    for s in [0x120,0X104,0x4B8,0x22E,0x5C0,0X64C,0x638,0X652,0x658,0X744,0X746,0X748,0x752,0xE4,0xEA,0xB4,0x556,0X65E,0X59A,0x5B6,0x5A4,0XDE,0X5E8,0x57D,0x5dc,0x6da,0x76a,0x524,0x26,0x21A,0x21C,0x12A,0x5E0]:
        rval[s] = s+1
    # paired with +2
    for s in [0x648,0X478,0X222,0x223,0X22,0x738,0X73C,0x18E,0x64E,0x654,0X740,0X634,0x582,0X474,0X65A,0x58A,0x5EF,0x5EE,0X46B,0x655,0X65B,0X465,0x466,0X470,0x471,0x74A,0x74C,0x735,0X217,0X187,0X58d,0X216,0x5dd,0x7a2,0x7a4,0x47c,0x46A,0x79E,0x186,0x734,0x5DC,0x5EA,0x5EB]:
        rval[s] = s+2
    # paired with +4 (not the most interesting work to do... identify pairs manually...)
    for s in [0X675,0x174,0x4C4,0x6F8,0X12,0x510,0x155,0X175,0x59C,0x674,0x684,0x685,0x694,0x695,0X530,0x56A,0X500,0x550,0x672,0x152,0X162,0x154,0X162,0x396,0x69A,0x42,0x3A,0x4A,0X16A,0X1BE,0X40,0x1A,0X1A4,0X13A,0X14A,0x15A,
